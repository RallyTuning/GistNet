...
namespace GistNet
{
    ...
    public class MyGists
    {
        ...
        /// <summary>
        /// Explore your own Gists by browsing a specific page. (30 per page)
        /// </summary>
        /// <param name="Token">Personal Token key from GitHub</param>
        /// <param name="Page">Optional: Number of the page to check. Default is 1</param>
        public MyGists(string Token, int Page)
        {
            if (string.IsNullOrWhiteSpace(Token)) { throw new Exception("Empty Token"); }
        ...
        /// <summary>
        /// Explore your own Gists from a specific date, by max amount of them per page and how many in every page
        /// </summary>
        /// <param name="Token">Personal Token key from GitHub</param>
        /// <param name="Per_Page">Optional: Number of items per page. Default is 30</param>
        /// <param name="Page">Optional: Number of the page to check. Default is 1</param>
        public MyGists(string Token, int Per_Page, int Page)
        {
            if (string.IsNullOrWhiteSpace(Token)) { throw new Exception("Empty Token"); }
        ...
        /// <summary>
        /// Explore your own Gists from a specific date
        /// </summary>
        /// <param name="Token">Personal Token key from GitHub</param>
        ...
        public MyGists(string Token, DateTime Since)
        {
            if (string.IsNullOrWhiteSpace(Token)) { throw new Exception("Empty Token"); }
            StrToken = Token;
        ...
        /// <param name="Per_Page">Optional: Number of items per page. Default is 30</param>
        /// <param name="Page">Optional: Number of the page to check. Default is 1</param>
        public MyGists(string Token, DateTime Since, int Per_Page, int Page)
        {
            if (string.IsNullOrWhiteSpace(Token)) { throw new Exception("Empty Token"); }
